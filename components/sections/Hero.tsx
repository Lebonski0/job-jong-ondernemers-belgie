        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-[10px] font-black text-zinc-300 uppercase tracking-[0.22em]">
              Exclusieve toegang · Nog <span className="text-white">52 plaatsen</span> beschikbaar
            </span>
          </motion.div>
          ...
          >
            <div className="flex -space-x-2.5" role="list" aria-label="Huidige leden">
              ...
              <div className="w-9 h-9 rounded-full border-2 border-[#020203] bg-zinc-900 ring-1 ring-white/10 flex items-center justify-center shrink-0" style={{ zIndex: 0 }}>
                <span className="text-[9px] font-black text-zinc-400">+43</span>
              </div>
            </div>
            <div className="text-left">
              ...
              <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">48 actieve leden · 4.9/5</p>
            </div>
          </motion.div>
            ...
            <div className="flex justify-between items-start mb-5">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-black tracking-tight text-white">48</span>
              ...
              <div className="text-right">
                ...
                <p className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest">Nog 52 vrij</p>
              </div>
            </div>
            <div className="h-1.5 w-full bg-white/[0.06] rounded-full overflow-hidden mb-5" role="progressbar" aria-valuenow={48} aria-valuemin={0} aria-valuemax={100} aria-label="48 van 100 plaatsen bezet">
              <motion.div
